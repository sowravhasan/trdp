  ...
  plugins: [
    ...
    `gatsby-plugin-transition-link`,
    {
      ...
      options: {
        ...
        theme_color: `#663399`,
        display: `minimal-ui`,
        icon: `src/images/hailis-hawaiian-food-icon.png`, // This path is relative to the root of the site.
      },
    },
    {
      ...
      options: {
        fonts: [
          `Open Sans\:400,700`,
          `Poppins\:light,bold`, // you can also specify font weights and styles
        ],
        display: "swap",
      },
    },
